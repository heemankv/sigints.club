...
import PrivateKeyFlow from "./components/PrivateKeyFlow";
...
export default function Home() {
  return (
    <>
      ...
      {/* Section 5 — Private subscription key mechanics */}
      <PrivateKeyFlow />

      {/* Section 6 — Redundancy / Global Compute Thesis */}
