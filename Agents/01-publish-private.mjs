...
const plaintext = getArg(args, "plaintext", process.env.SIGINTS_PLAINTEXT ?? "private signal: price=2000");
...
async function publishOnce() {
  const randomValue = (1 + Math.random() * 9).toFixed(2);
  ...
  console.log("published private signal:", signature);
}
